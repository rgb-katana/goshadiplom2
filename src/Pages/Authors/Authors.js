...
const Authors = observer(() => {
    ...
    const aut = authors.map((author) => {
        return (
            <div className="author">
                <div className="fio">{author.fio}</div>
                <div
                    className="text"
                    dangerouslySetInnerHTML={{ __html: author.text }}
                ></div>
                <div className="row">
    ...
    return (
        <div id="authors">
            ...
            <Download />
            <Space> </Space>
            <div className="header">ABOUT AUTHORS</div>
            <div className="text">
                Lorem ipsum dolor sit amet consectetur. Mauris tortor laoreet in
                eu enim. Id lectus ipsum lacinia et tincidunt ac consectetur.
                Eleifend mi in congue nunc faucibus magna commodo malesuada.
                Maecenas morbi tristique malesuada in ante imperdiet etiam donec
                posuere.
            </div>
            {aut}
        </div>
