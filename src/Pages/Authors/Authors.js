...
const Authors = observer(() => {
  ...
  return (
    <div id="authors">
      ...
      <div className="text">
        Lorem ipsum dolor sit amet consectetur. Mauris tortor laoreet in eu
        enim. Id lectus ipsum lacinia et tincidunt ac consectetur. Eleifend mi
        in congue nunc faucibus magna commodo malesuada. Maecenas morbi
        tristique malesuada in ante imperdiet etiam donec posuere.
      </div>
      {aut}
    </div>
  );
